🎮 Hangman Game (Text-Based) A simple text-based Hangman game built with Python. The player must guess the hidden word one letter at a time within a limited number of incorrect attempts.
